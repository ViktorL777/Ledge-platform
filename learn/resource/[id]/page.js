  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: C.paper, fontFamily: "'DM Sans', system-ui, sans-serif", color: C.ink }}>
      <header style={{ borderBottom: `1px solid ${C.line}`, padding: '1rem 1.5rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
        ...
        <Link href="/" style={{ marginLeft: 'auto', textDecoration: 'none', display: 'flex', alignItems: 'baseline', gap: 2 }}>
          <span style={{ fontFamily: "'Fraunces', Georgia, serif", fontWeight: 600, fontSize: '1.1rem', color: C.blue }}>L</span>
          <span style={{ width: 11, height: 2, backgroundColor: C.copper, display: 'inline-block', marginBottom: 3 }} />
          <span style={{ fontFamily: "'Fraunces', Georgia, serif", fontWeight: 600, fontSize: '1.1rem', color: C.blue }}>edge</span>
        </Link>
      </header>
