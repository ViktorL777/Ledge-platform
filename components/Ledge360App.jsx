...
const TEMPLATE_KOMPETENCIA_B64 = '';
const TEMPLATE_PARTICIPANTS_B64 = '';
    ...
    <div style={{background:BG,minHeight:'100vh'}}>
      ...
      <div style={{maxWidth:700,margin:'0 auto',padding:'24px'}}>
        <Card style={{marginBottom:22}}>
          ...
          <Btn onClick={addMember} disabled={!fn.trim()}>+ Generate ID</Btn>
        </Card>
    ...
    for (const pk of projKeys) {
      ...
      if (ratIdx >= 0) {
        ...
        nav('survey', {
          ...
          surveyTitle:'Assessment — '+(part ? part.firstName+' '+part.lastName : 'Person'),
        });
        setLoading(false); return;
      }
    }
...
function ProjectView({ nav, goBack, ctx }) {
  ...
  async function handleBulkParticipants(e) {
    const file = e.target.files && e.target.files[0];
    if (!file) return;
    setBulkUploading(true); setBulkUploadMsg('');
    try {
      ...
      // Main sheet: "Feedback providers (optional)"
      const wsMain = wb.Sheets[wb.SheetNames[0]];
      const rawRows = XLSX.utils.sheet_to_json(wsMain, { header:1, defval:'' });

      // Extract Relationship Categories from column G (index 6)
      const relationshipCats = [];
      rawRows.forEach((r, i) => {
        if (i < 2) return; // skip header rows
        const cat = String(r[6] || '').trim();
        if (cat && !relationshipCats.includes(cat)) relationshipCats.push(cat);
      });

      // Auto-update project roles from Relationship Categories
      if (relationshipCats.length > 0) {
        const RCAT_COLORS = [BLUE, GREEN, PURP, ORAN, RED, GOLD, '#5B8A8A', '#8A5B7A'];
        const newRoles = relationshipCats.map((cat, i) => ({
          id: 'role_' + cat.toLowerCase().replace(/\s+/g,'_'),
          label: cat,
          color: RCAT_COLORS[i % RCAT_COLORS.length]
        }));
        const updatedProj = { ...proj, roles: newRoles };
        await db.set(projectId, updatedProj);
        setProj(updatedProj);
      }

      // Parse data rows — skip title row (row 0) and header row (row 1)
      const dataRows = rawRows.slice(2);
      // Group by "People to Assess" (col 0 = Full Name, col 1 = Email)
      // Feedback Provider: col 2 = Full Name, col 3 = Email, col 4 = Relationship
      const participantMap = {};
      const participantOrder = [];
      dataRows.forEach(r => {
        const assessedName = String(r[0] || '').trim();
        const assessedEmail = String(r[1] || '').trim();
        const providerName = String(r[2] || '').trim();
        const providerEmail = String(r[3] || '').trim();
        const relationship = String(r[4] || '').trim();
        if (!assessedName && !providerName) return;
        if (assessedName) {
          const key = assessedName + '|' + assessedEmail;
          if (!participantMap[key]) {
            participantMap[key] = { name: assessedName, email: assessedEmail, providers: [] };
            participantOrder.push(key);
          }
          if (providerName) {
            participantMap[key].providers.push({ name: providerName, email: providerEmail, relationship });
          }
        } else if (providerName && participantOrder.length > 0) {
          // Continuation row — belongs to last participant
          const lastKey = participantOrder[participantOrder.length - 1];
          participantMap[lastKey].providers.push({ name: providerName, email: providerEmail, relationship });
        }
      });

      let partCount = 0; let provCount = 0;
      const currentRoles = (await db.get(projectId))?.roles || DEFAULT_ROLES;
      for (const key of participantOrder) {
        const p = participantMap[key];
        const nameParts = p.name.trim().split(/\s+/);
        const firstName = nameParts[0] || p.name;
        const lastName  = nameParts.slice(1).join(' ');
        const partId = 'part:' + uid(10);
        await db.set(partId, { id:partId, projectId, firstName, lastName, email:p.email, created:Date.now() });
        // Self rater
        const selfCode = uid(12);
        const selfRatId = 'rat:' + uid(10);
        await db.set(selfRatId, { id:selfRatId, participantId:partId, projectId, firstName, lastName, role:'self', code:selfCode, status:'pending' });
        partCount++;
        // Feedback providers
        for (const fp of p.providers) {
          const fpParts = fp.name.trim().split(/\s+/);
          const fpFirst = fpParts[0] || fp.name;
          const fpLast  = fpParts.slice(1).join(' ');
          const relRole = currentRoles.find(r => r.label.toLowerCase() === fp.relationship.toLowerCase());
          const roleId  = relRole ? relRole.id : ('role_' + fp.relationship.toLowerCase().replace(/\s+/g,'_'));
          const ratId   = 'rat:' + uid(10);
          await db.set(ratId, { id:ratId, participantId:partId, projectId, firstName:fpFirst, lastName:fpLast, email:fp.email, role:roleId, code:uid(12), status:'pending' });
          provCount++;
        }
      }

      setBulkUploadMsg(`✓ ${partCount} értékelt és ${provCount} visszajelző importálva.`);
      setTimeout(() => setBulkUploadMsg(''), 4000);
      load();
    } catch(err) {
      setBulkUploadMsg('Hiba: ' + err.message);
    }
    setBulkUploading(false);
    if (bulkPartRef.current) bulkPartRef.current.value = '';
  }
    ...
    <div style={{background:BG,minHeight:'100vh'}}>
      ...
      <div style={{maxWidth:860,margin:'0 auto',padding:'22px 24px'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(4,1fr)',gap:10,marginBottom:22}}>
          {[
            {label:'People to assess',val:parts.length, color:GOLD},
            {label:'Feedback providers', val:raters.length,color:BLUE},
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:8}}>
          <div style={{fontSize:12,color:MUTED,textTransform:'uppercase',letterSpacing:'.08em'}}>People to assess</div>
          <div style={{display:'flex',gap:8,alignItems:'center'}}>
            <Btn variant="ghost" size="sm" onClick={() => downloadBase64Excel(TEMPLATE_PARTICIPANTS_B64, 'Ledge360_People_Template.xlsx')}>⬇ Excel sablon</Btn>
            <Btn variant="ghost" size="sm" onClick={() => bulkPartRef.current && bulkPartRef.current.click()} disabled={bulkUploading}>
              {bulkUploading ? 'Importálás...' : '⬆ Excel feltöltés'}
            </Btn>
            <input ref={bulkPartRef} type="file" accept=".xlsx,.xls" onChange={handleBulkParticipants} style={{display:'none'}}/>
            <Btn variant="ghost" size="sm" onClick={() => setAddingP(!addingP)}>+ Egyéni hozzáadás</Btn>
          </div>
        </div>
        {bulkUploadMsg && (
          <div style={{background: bulkUploadMsg.startsWith('✓') ? `${GREEN}18` : `${RED}18`, border:`1px solid ${bulkUploadMsg.startsWith('✓') ? GREEN : RED}44`, borderRadius:8, padding:'8px 14px', marginBottom:12, fontSize:13, color: bulkUploadMsg.startsWith('✓') ? GREEN : RED}}>
            {bulkUploadMsg}
          </div>
        )}
        ...
        {parts.length === 0 && !addingP && (
          <Card style={{textAlign:'center',padding:28,color:MUTED}}>Add people to assess to start the project.</Card>
        )}
            ...
            <Card key={part.id} style={{marginBottom:10}}>
              <div style={{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:8,gap:12}}>
                ...
                <div style={{display:'flex',gap:8,alignItems:'center',flexShrink:0}}>
                  ...
                  <button onClick={() => setDeletingPartId(part.id)} style={{background:'none',border:'none',color:DIM,cursor:'pointer',fontSize:14,padding:4}} title="Remove assessed person">✕</button>
                </div>
              </div>
              {pr.length > 0 && (
                <div style={{display:'flex',gap:6,flexWrap:'wrap'}}>
      ...
      {deletingPartId && (
        <ConfirmModal
          title="Remove assessed person"
          message="This person and all their feedback providers will be deleted. This action cannot be undone."
          confirmLabel="Igen, törlés"
        ...
        <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.25)',backdropFilter:'blur(4px)',zIndex:200,display:'flex',alignItems:'center',justifyContent:'center',padding:20}}>
          <div style={{background:'#FFFFFF',border:`1px solid ${BORD}`,borderRadius:18,padding:30,width:'100%',maxWidth:480,boxShadow:'0 8px 30px rgba(0,0,0,.1)',maxHeight:'90vh',overflowY:'auto'}}>
            ...
            <div style={{marginTop:20,marginBottom:8}}>
              <div style={{fontSize:11,color:MUTED,textTransform:'uppercase',letterSpacing:'.08em',marginBottom:12}}>Relationship to the person assessed</div>
              ...
              <div style={{background:S2,borderRadius:10,padding:'12px 14px',border:`1px solid ${BORD}`}}>
                ...
                <div style={{display:'flex',gap:8,alignItems:'center',marginBottom:8}}>
                  <input
                    ...
                    placeholder="e.g. HR Manager, Mentor..."
...
function RatersView({ nav, goBack, ctx }) {
  ...
  async function handleBulkImport(e) {
    ...
    try {
      ...
      if (count === 0) { setBulkError('No importable rows found.'); }
      else { setBulkError(''); }
      load();
    } catch(err) {
  ...
  return (
    <div style={{background:BG,minHeight:'100vh'}}>
      <TopBar title={(part ? part.firstName+' '+part.lastName : '') + ' — Feedback providers'} back onBack={goBack}/>
      <div style={{maxWidth:680,margin:'0 auto',padding:'22px 24px'}}>
        <Card style={{marginBottom:18}}>
          <div style={{fontSize:13,color:GOLD,fontWeight:600,marginBottom:12}}>Add feedback provider</div>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
            <Input label="Keresztnév" value={fn} onChange={setFn} placeholder="Péter"/>
            <Input label="Vezetéknév" value={ln} onChange={setLn} placeholder="Nagy"/>
          </div>
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
            <Input label="Email" value={em} onChange={setEm} placeholder="email@ceg.hu"/>
            <div style={{marginBottom:14}}>
              <div style={{fontSize:11,color:MUTED,marginBottom:5,textTransform:'uppercase',letterSpacing:'.08em'}}>Relationship to the person assessed</div>
          ...
          <Btn onClick={add} disabled={!fn.trim()}>+ Generate ID</Btn>
          <div style={{display:'flex',gap:8,alignItems:'center',marginTop:10,paddingTop:10,borderTop:`1px solid ${BORD}`}}>
            <Btn variant="ghost" size="sm" onClick={() => bulkRef.current && bulkRef.current.click()} disabled={bulkImporting}>
              {bulkImporting ? 'Importálás...' : '⬆ Excel feltöltés'}
            </Btn>
            <input ref={bulkRef} type="file" accept=".csv,.tsv,.xlsx,.xls,.txt" onChange={handleBulkImport} style={{display:'none'}}/>
            <span style={{fontSize:11,color:MUTED}}>First name;Last name;Email;Relationship</span>
          </div>
          {bulkError && <div style={{fontSize:12,color:RED,marginTop:6}}>{bulkError}</div>}
        </Card>

        {raters.length === 0 && (
          <div style={{textAlign:'center',padding:'24px 0',color:MUTED,fontSize:14}}>No feedback providers added yet.</div>
        )}
...
function LibraryManagerView({ nav, goBack, ctx }) {
  ...
  function importRows(rows) {
    ...
    // A) Template format: Competency | Short Code | Subcompetence | Behavior
    // B) Legacy format:   Kompetencia | Rövid kód | Label | Alkompetencia ID | Értékelendő mondat
    const firstRow = rows[0] || [];
    const isTemplateFormat = firstRow.length >= 3 &&
      (String(firstRow[0]||'').toLowerCase().includes('competency') ||
       String(firstRow[2]||'').toLowerCase().includes('subcompetence') ||
       String(firstRow[3]||'').toLowerCase().includes('behavior'));
    if (isTemplateFormat) { rows = rows.filter(r => r[0] && !String(r[0]).startsWith('⬇')); }
    const dimMap = {};
    const dimOrder = [];
    rows.forEach(r => {
      if (isTemplateFormat) {
        // Competency | Short Code | Subcompetence | Behavior
        const compName = (r[0] || '').toString().trim();
        const shortCode = (r[1] || '').toString().trim();
        const subcomp  = (r[2] || '').toString().trim();
        const behavior = (r[3] || '').toString().trim();
        if (!compName || compName.startsWith('⬇')) return;
        const key = shortCode || compName.replace(/\s+/g,'_').substring(0,8).toUpperCase();
        if (!dimMap[key]) {
          dimMap[key] = { id:key, name:compName, label:compName, color:DIM_COLORS[dimOrder.length % DIM_COLORS.length], items:[] };
          dimOrder.push(key);
        }
        if (behavior) {
          const iid = shortCode ? shortCode + '_' + (dimMap[key].items.length+1) : key + (dimMap[key].items.length+1);
          dimMap[key].items.push({ id:iid, text:subcomp ? subcomp + ' — ' + behavior : behavior });
        }
      } else {
        // Legacy: Kompetencia | Rövid kód | Label | Alkompetencia ID | Értékelendő mondat
    ...
    <div style={{background:BG,minHeight:'100vh'}}>
      ...
      <div style={{maxWidth:800,margin:'0 auto',padding:'22px 24px'}}>
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',flexWrap:'wrap',gap:10,marginBottom:18}}>
          ...
          <div style={{display:'flex',gap:8,flexWrap:'wrap'}}>
            <Btn variant="ghost" size="sm" onClick={() => downloadBase64Excel(TEMPLATE_KOMPETENCIA_B64, 'Kompetencia_Sablon_360.xlsx')}>⬇ Excel sablon</Btn>
            <Btn variant="ghost" size="sm" onClick={() => fileRef.current && fileRef.current.click()}>⬆ Excel feltöltés</Btn>
        ...
        <div style={{background:S2,border:`1px solid ${BORD}`,borderRadius:10,padding:'12px 16px',marginBottom:20,fontSize:13,color:MUTED,lineHeight:1.6}}>
          <b style={{color:TEXT}}>Tipp:</b> Húzd az ☰ ikont a kompetenciák vagy alkompetenciák átrendezéséhez. Kattints bármelyik szövegre a szerkesztéshez. Az Excel sablont letöltheted, kitöltöd, és visszatöltheted.
        </div>
